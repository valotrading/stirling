...
@RunWith(JDaveRunner.class) public class FixMessageQueueSpec extends Specification<FixMessageQueue> {
    private FixMessageQueue queue = new FixMessageQueue();

    public class EmptyQueue {
        public FixMessageQueue create() {
            return queue;
        }
