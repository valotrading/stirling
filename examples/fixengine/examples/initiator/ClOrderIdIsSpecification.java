 ...
 * @author Pekka Enberg 
 */
public class ClOrderIdIsSpecification extends AbstractMessageMatchingSpecification {
    private final String clOrdId;

    public ClOrderIdIsSpecification(String clOrdId) {
    ...
    protected MessageMatchingVisitor newMatching() {
        return new AbstractMessageMatchingVisitor() {
            ...
            public void visit(ExecutionReportMessage message) {
                result = clOrdId.equals(message.getClOrdId());
            }
        };
    }
}
