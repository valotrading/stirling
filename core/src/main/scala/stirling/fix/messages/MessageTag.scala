...
abstract class EnumTag[T](value: Int) extends MessageTag[EnumField[Value[T]]](value, classOf[EnumField[Value[T]]]) {
  def newField(required: Required) = new EnumField(this, required)
