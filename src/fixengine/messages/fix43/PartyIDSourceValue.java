...
public enum PartyIDSourceValue implements Formattable {
    CUSTOM('D');

    private char value;

    PartyIDSourceValue(char value) {
        this.value = value;
    }
    ...
    public static PartyIDSourceValue parse(char value) {
        for (PartyIDSourceValue type : PartyIDSourceValue.values()) {
            if (type.value == value)
                return type;
        }
