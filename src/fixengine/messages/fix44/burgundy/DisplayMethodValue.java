...
public enum DisplayMethodValue implements Formattable {
    RANDOM('3');

    private char value;

    DisplayMethodValue(char value) {
        this.value = value;
    }
    ...
    public static DisplayMethodValue parse(char value) {
        for (DisplayMethodValue type : DisplayMethodValue.values()) {
            if (type.value == value)
                return type;
        }
