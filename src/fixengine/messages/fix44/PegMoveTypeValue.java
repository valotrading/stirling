...
public enum PegMoveTypeValue implements Formattable {
    FLOATING('0'),
    FIXED('1');

    private char value;

    PegMoveTypeValue(char value) {
        this.value = value;
    }
    ...
    public static PegMoveTypeValue parse(char value) {
        for (PegMoveTypeValue type : PegMoveTypeValue.values()) {
            if (type.value == value)
                return type;
        }
