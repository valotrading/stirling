...
public enum PegOffsetTypeValue implements Formattable {
    PRICE('0'),
    BASIS_POINTS('1'),
    TICKS('2'),
    PRICE_TIER_LEVEL('3');
    ...
    public static PegOffsetTypeValue parse(char value) {
        for (PegOffsetTypeValue type : PegOffsetTypeValue.values()) {
            if (type.value == value)
                return type;
        }
