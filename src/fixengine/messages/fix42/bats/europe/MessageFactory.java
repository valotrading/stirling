...
import static fixengine.messages.fix42.bats.europe.MsgTypeValue.*;
...
public class MessageFactory extends fixengine.messages.fix42.DefaultMessageFactory {
    public MessageFactory() {
        ...
        message(TRADE_CANCEL_CORRECT, OrderModificationRequestMessage.class);
    }
