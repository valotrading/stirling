...
public enum SecurityIDValue implements Formattable {
    SEDOL('2'),
    ISIN('4'),
    RIC('5');
    ...
    public static SecurityIDValue parse(char value) {
        for (SecurityIDValue type : SecurityIDValue.values()) {
            if (type.value == value)
                return type;
        }
