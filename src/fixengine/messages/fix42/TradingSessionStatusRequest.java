...
public class TradingSessionStatusRequest extends AbstractMessage implements fixengine.messages.TradingSessionStatusRequest {
    public TradingSessionStatusRequest(MessageHeader header) {
        super(header);
