...
public enum OrderCapacityValue implements Formattable {
    ...
    public static OrderCapacityValue parse(char value) {
        for (OrderCapacityValue type : OrderCapacityValue.values()) {
            if (type.value == value)
                return type;
        }
